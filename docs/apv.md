...
Een lid van het staffteam heeft de mogelijkheid om op basis van de context, situatie of eerdere straffen/waarschuwingen van een overtreder te beslissen om straffen te verhogen of te verlagen. Als je het niet eens bent met de beslissing van een lid van het staffteam, kun je een ticket aanmaken om dit aan te kaarten.

## Openbare orde

### Artikel 1 - Fail-RP en Powergaming

1. <b>FailRP:</b> Het is niet toegestaan om opzettelijk een roleplay van zeer slechte kwaliteit uit te spelen.
...
3. Enkele voorbeelden van FailRP en Powergaming zijn hieronder beschreven, maar niet beperkt tot:
    ...
    * Geen realistische reactie hebben op eventuele verwondingen en/of andere medische situaties.
...
3. Indien je in een Discord-call zit met mensen die op hetzelfde moment ook op Springbank aan het spelen zijn is het niet toegestaan om je scherm te delen en is het noodzaak dat iedereen zowel zijn microfoon als koptelefoon heeft gemute op Discord.
...
1. Het is niet toegestaan om tijdens een actief scenario de stad te verlaten op welke manier dan ook. 
...
4. Tijdens stafzaken is het in de basis zaak dat er ten allen tijden Nederlands wordt gesproken.
...
2. Enkele voorbeelden hiervan zijn maar niet beperkt tot:
	...
	* Stafleden benaderen die in dienst zijn en bezig zijn met het afhandelen van een stafzaak.
...
3. Het is zaak om ervoor te zorgen dat jouw armen niet door jouw tshirt heenkomen.
4. Het is niet toegestaan om kleding van overheidsdiensten te dragen zonder goede aanleiding.
...
2. Regel 1 geld alleen voor drugs op een pluk locatie.
...
1. Het gebruik van body- en/of dashcam beelden in een roleplay scenario is alleen toegestaan indien deze aan de volgende voorwaarden voldoet:
    ...
    * Burgers kunnen alleen met fysieke camera's, zoals met /e camera of met de camera van je telefoon.
    * Overheidsvoertuigen zijn uitgerust met dashcams
2. Voor de afhandeling van stafzaken mag elke manier van videomateriaal gebruikt worden en zijn de bovenstaande voorwaarden dus niet van toepassing.
